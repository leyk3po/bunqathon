...
import { Box, Flex, Image, Link as ChakraLink, QrCode, Text } from "@chakra-ui/react";
...
function LogoMark() {
  return <Image src="/logo.png" alt="FlashDrop" display="block" draggable={false} h="clamp(24px, 2.4vw, 36px)" w="auto" />;
}

function NavGithubLink() {
  return (
    <ChakraLink
      href="https://github.com/leyk3po/bunqathon"
      target="_blank"
      rel="noreferrer"
      display="inline-flex"
      alignItems="center"
    ...
    >
      <Box as="span" lineHeight="1" display="inline-flex">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.11.79-.25.79-.56 0-.27-.01-1.16-.02-2.1-3.2.7-3.87-1.36-3.87-1.36-.52-1.32-1.27-1.67-1.27-1.67-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.02 1.75 2.68 1.25 3.34.95.1-.74.4-1.25.73-1.54-2.55-.29-5.24-1.28-5.24-5.69 0-1.26.45-2.28 1.18-3.08-.12-.29-.51-1.46.11-3.04 0 0 .97-.31 3.18 1.18a11 11 0 0 1 5.78 0c2.21-1.49 3.18-1.18 3.18-1.18.62 1.58.23 2.75.11 3.04.74.8 1.18 1.82 1.18 3.08 0 4.42-2.69 5.39-5.25 5.68.41.35.78 1.04.78 2.1 0 1.51-.01 2.73-.01 3.1 0 .31.21.68.8.56C20.21 21.39 23.5 17.07 23.5 12 23.5 5.65 18.35.5 12 .5Z" />
        </svg>
      </Box>
      <Text
        fontSize="13px"
      ...
      <Box bg={DARK} color={INK_FG} px={{ base: "24px", md: "56px" }} pt={{ base: "72px", md: "120px" }} pb={{ base: "32px", md: "48px" }}>
        ...
        >
          ...
          <Flex gap="24px" wrap="wrap">
            <ChakraLink href="https://github.com/leyk3po/bunqathon" _hover={{ opacity: 1 }}>GitHub ↗</ChakraLink>
            <ChakraLink href="https://doc.bunq.com" _hover={{ opacity: 1 }}>Bunq Docs ↗</ChakraLink>
          </Flex>
        </Flex>
      </Box>
    </Box>
